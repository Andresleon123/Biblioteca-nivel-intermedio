...
public class BibliotecaApp extends JFrame {
    ...
    private void agregarAcciones() {
        btnAgregar.addActionListener(e -> {
            // Extraer los valores de los componentes de la interfaz gráfica
            String nombre = txtNombre.getText();
            String autor = txtAutor.getText();
            String editorial = txtEditorial.getText();
            int fecha = Integer.parseInt(txtFecha.getText()); // Asegúrate de que txtFecha contenga un número válido
            String genero = txtGenero.getText();
            boolean disponible = chkDisponible.isSelected();
            String comentarios = textArea.getText(); // Si necesitas comentarios, de lo contrario, puedes dejarlo vacío

            // Llamar al método agregarLibro con los valores extraídos
            logica.agregarLibro(txtNombre, txtAutor, txtEditorial, txtFecha, txtGenero, chkDisponible, textArea);
        });
